...
/**
 * Profile Component
 * Manages user personal information, address location, and forum subscriptions.
 * Handles both editing state for updates and secure account deletion workflow.
 */
function Profile() {
  ...
  // Manage forum subscriptions and data fetching via custom hook
  const {
    forums,
    isLoading: forumsLoading,
    toggleFollowForum,
  } = useForums(targetUserId);
  ...
  // State for the options dropdown menu
  ...
  return (
    <main
      ...
      dir="rtl"
      style={{ padding: "24px 32px", fontFamily: "Heebo, sans-serif" }}
    >
      <div style={card}>
        ...
        <div style={{ marginTop: "10px" }}>
          {isEditing ? (
            ...
            <p
              style={{
                color: display.about ? "#1A1A2E" : "#9CA3AF",
                fontSize: "15px",
                lineHeight: "1.7",
                margin: 0,
              }}
        ...
        <div style={{ ...grid, marginTop: "12px" }}>
          ...
          <EditableField
            label="תחום לימודים"
            name="studyField"
            value={display.studyField}
            isEditing={isEditing}
            onChange={handleInputChange}
            error={profileErrors.studyField}
          />
          <EditableField
            label="שנת לימודים"
            name="year"
        ...
        {/* Unified Forums Catalog Subsection */}
        <div style={sectionTitle}>הפורומים שלי</div>
        <p
          style={{ fontSize: "13px", color: "#6B7280", margin: "4px 0 16px 0" }}
        >
        ...
        >
          {isEditing ? (
            ...
            <button onClick={handleStartEdit} style={primaryBtn}>
              עריכת פרופיל
            </button>
          )}
        </div>
      ...
      {showDeleteConfirm && (
        ...
        >
          ...
          >
            ...
            >
              האם את/ה בטוח/ה? פעולה זו תמחק את החשבון שלך לצמיתות, ולא ניתן
              יהיה לשחזר אותה.
            </p>
            <div
...
const primaryBtn = {
  ...
  fontSize: "14px",
  fontFamily: "Heebo, sans-serif",
  boxShadow: "0 2px 6px rgba(56,189,248,0.22)",
};
const secondaryBtn = {
  backgroundColor: "white",
  color: "#4B5563",
